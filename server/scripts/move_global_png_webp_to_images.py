...
TARGET_MIME_TYPES = {"image/png", "image/webp"}
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description='Create/update a project named "Images" and move global PNG/WEBP files into it.'
    )
    ...
    print(f"Found {len(files)} matching global PNG/WEBP file(s).")
